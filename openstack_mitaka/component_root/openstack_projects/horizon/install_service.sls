...
openstack_conf_compress:
  cmd: 
    - run
    - name: 'sudo python /usr/share/openstack-dashboard/manage.py compress'
    - require:
      - file: update-dashboard-conf-settings
