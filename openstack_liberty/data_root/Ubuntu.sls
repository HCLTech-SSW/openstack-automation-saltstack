packages:
  ...
  sys_fsutils: sysfsutils
  neutron_server: neutron-server
  neutron_ml2: neutron-plugin-ml2
  neutron_plugin_linuxbridge_agent: neutron-plugin-linuxbridge-agent
  ...
  conntrack: conntrack
  cinder_client: python-cinderclient
...
conf_files:
  ...
  dns_masq: "/etc/neutron/dnsmasq-neutron.conf"
